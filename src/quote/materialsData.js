...
export const MATERIALS = [
  ...
  { id:'tough1500', name:'Tough 1500', uses:['end_use','prototyping','tooling'], props:['Impact resistant','Snap-fit capable'], desc:'Good for functional prototypes and light-duty fixtures.' },
  { id:'high_temp', name:'High Temp', uses:['end_use','tooling'], props:['Heat deflection','Thermal testing'], desc:'Great for hot-air, fluid, or autoclave-adjacent components.' },
  ...
  { id:'durable', name:'Durable', uses:['prototyping','end_use'], props:['Wear resistant','Low friction'], desc:'Suited for bushings, clips, and low-friction components.' },
  ...
  { id:'black', name:'Black', uses:['prototyping'], props:['General purpose'], desc:'Smooth surface finish for cosmetic models.' },
  { id:'grey', name:'Grey', uses:['prototyping'], props:['Detail'], desc:'Neutral surface that photographs well for design reviews.' },
