...
export const MATERIALS = {
  ...
  "flexible-80a":   { label: "Flexible 80A",   resinCostPerL: 199, buildRateCm3H: 16, supportWaste: 0.18, machineRatePerHour: 8, laborRatePerHour: 12, postProcessFactor: 1.0, minPrice: 18 },
  "elastic-50a":    { label: "Elastic 50A",    resinCostPerL: 199, buildRateCm3H: 15, supportWaste: 0.22, machineRatePerHour: 8, laborRatePerHour: 12, postProcessFactor: 1.0, minPrice: 18 },
  ...
  "castable-wax":   { label: "Castable Wax",   resinCostPerL: 299, buildRateCm3H: 17, supportWaste: 0.14, machineRatePerHour: 8, laborRatePerHour: 12, postProcessFactor: 1.0, minPrice: 22 },
  "durable-resin":  { label: "Durable Resin",  resinCostPerL: 149, buildRateCm3H: 19, supportWaste: 0.10, machineRatePerHour: 8, laborRatePerHour: 12, postProcessFactor: 1.0, minPrice: 14 },
  "precision-model":{ label: "Precision Model",resinCostPerL: 129, buildRateCm3H: 18, supportWaste: 0.13, machineRatePerHour: 8, laborRatePerHour: 12, postProcessFactor: 1.0, minPrice: 20 },
  "flame-retardant":{ label: "Flame Retardant",resinCostPerL: 249, buildRateCm3H: 19, supportWaste: 0.14, machineRatePerHour: 8, laborRatePerHour: 12, postProcessFactor: 1.0, minPrice: 19 },
};
